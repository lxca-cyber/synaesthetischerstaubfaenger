...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/synaesthetischerstaubfaenger)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/synaesthetischerstaubfaenger
```

A live public deployment of this template is available at [https://synaesthetischerstaubfaenger.templates.workers.dev](https://synaesthetischerstaubfaenger.templates.workers.dev)
